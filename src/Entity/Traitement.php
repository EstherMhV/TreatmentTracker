...
class Traitement
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=PoolVm::class, inversedBy="traitements")
     * @ORM\JoinColumn(nullable=false)
     */
    private $id_pool;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Traitement", mappedBy="parentTraitement", cascade={"persist", "remove"})
     */
    private $replanifications;

    /**
     * @ORM\ManyToOne(targetEntity="Traitement", inversedBy="replanifications")
    ...
    public function getIdPool(): ?PoolVm
    {
        return $this->id_pool;
    }

    public function setIdPool(?PoolVm $id_pool): self
    {
    ...
    public function addReplanification(Traitement $replanification): self
    {
    ...
    public function removeReplanification(Traitement $replanification): self
    {
